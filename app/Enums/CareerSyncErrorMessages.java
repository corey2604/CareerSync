...
public enum CareerSyncErrorMessages {
    ...
    PASSWORD_DOES_NOT_CONFORM("Please enter a password that is at least 8 characters long. It must contain at least one of the following: an uppercase character, a lowercase character, a number and a special character."),
